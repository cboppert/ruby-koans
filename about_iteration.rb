...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # The value given to inject sets the first variable in the block
    # and the second variable in the block is each item as the list
    # is enumerated and then the block is executed and stored in
    # the first variable
  end
  ...
  # because file is each line when done the original way and the file
  # gets enumerated over
