...
class AboutClassMethods < Neo::Koan
  ...
  # class << self sets self to Demo's metaclass for the duration
  # of the block
  # self.method adds a method to classes metaclass but does
  # not change self to the metaclass, instead it is still
  # the class itself.
  # When using << instances may not use the method without
  # calling their class first.
