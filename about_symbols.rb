...
class AboutSymbols < Neo::Koan
  ...
  # include is not a method on Symbol and symbols do not have
  # string methods
  ...
  # since symbols are immutable you might end up creating the same symbol
  # and then receive errors when using said symbol for your original value
end
